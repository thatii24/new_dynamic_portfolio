        ...
        <section id="hero" className="relative w-full min-h-screen py-24 sm:py-28 md:py-32 flex flex-col justify-center px-6 md:px-12 snap-center">
          <div className="relative z-10 flex flex-col md:flex-row items-center justify-between w-full gap-10 md:gap-12 mt-8 md:mt-12">
            ...
            <div className="flex flex-col max-w-md">
              ...
              <div className="mt-6 md:mt-8 text-[#ff3b47] font-bold text-xl md:text-2xl uppercase tracking-wide drop-shadow-[0_0_12px_rgba(255,59,71,0.4)]">
                Web Designer &<br />UI/UX Creator
              </div>
              <p className="mt-5 md:mt-6 text-white/90 text-sm md:text-base leading-relaxed">
              ...
              <div className="mt-6 md:mt-8 flex flex-wrap items-center gap-4 sm:gap-6">
                <div className="flex items-center gap-3 text-xs uppercase tracking-widest text-white/90 font-semibold">
                  <div className="w-8 h-8 rounded-full bg-[#ff3b47] flex items-center justify-center shadow-[0_0_10px_#ff3b47]">
                ...
                <div className="flex items-center gap-3.5 sm:gap-4.5 text-white/90">
                  <a
                    ...
                    aria-label="Facebook"
                    className="text-white/80 hover:text-[#ff3b47] transition-all duration-300 hover:scale-125 hover:drop-shadow-[0_0_10px_rgba(255,59,71,0.8)]"
                  >
            ...
            <div className="flex flex-row md:flex-col items-center justify-between sm:justify-around md:justify-end gap-3 sm:gap-6 md:gap-12 w-full md:w-auto pt-6 md:pt-0 border-t md:border-t-0 border-white/10 text-left md:text-right">
              <div className="flex flex-col sm:flex-row md:flex-row items-center justify-center md:justify-end gap-1 sm:gap-3 md:gap-4 text-center sm:text-left">
                ...
                <span className="text-[10px] sm:text-xs uppercase tracking-wider sm:tracking-widest text-white/90 font-medium text-center sm:text-left leading-tight sm:w-24">
                  Years<br className="hidden sm:block" /> Experience
                </span>
              </div>
              <div className="flex flex-col sm:flex-row md:flex-row items-center justify-center md:justify-end gap-1 sm:gap-3 md:gap-4 text-center sm:text-left">
                <span className="text-4xl sm:text-5xl md:text-6xl font-oswald text-[#ff3b47] leading-none drop-shadow-[0_0_15px_rgba(255,59,71,0.4)]">40+</span>
                <span className="text-[10px] sm:text-xs uppercase tracking-wider sm:tracking-widest text-white/90 font-medium text-center sm:text-left leading-tight sm:w-24">
                  Projects<br className="hidden sm:block" /> Completed
                </span>
              </div>
              <div className="flex flex-col sm:flex-row md:flex-row items-center justify-center md:justify-end gap-1 sm:gap-3 md:gap-4 text-center sm:text-left">
                <span className="text-4xl sm:text-5xl md:text-6xl font-oswald text-[#ff3b47] leading-none drop-shadow-[0_0_15px_rgba(255,59,71,0.4)]">20+</span>
                <span className="text-[10px] sm:text-xs uppercase tracking-wider sm:tracking-widest text-white/90 font-medium text-center sm:text-left leading-tight sm:w-24">
